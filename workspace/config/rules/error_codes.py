class ResultCode:
    ...
    UUID_GEN_FAIL = 40019
    ASSERT_STATUS_CODE_MISMATCH = 40020
    ASSERT_KEYS_MISSING = 40021
    ASSERT_JSON_MISMATCH = 40022
    ASSERT_SUBSTRING_NOT_FOUND = 40023
    TOOL_FILE_DELETE_FAILED = 40024
    TOOL_RESPONSE_JSON_PARSE_FAILED = 40025
    TOOL_RESPONSE_DATA_MISSING = 40026
    TOOL_RESPONSE_FIELD_MISSING = 40027
    TOOL_TIME_INVALID_TIMEZONE = 40028
    TOOL_TIME_INVALID_FORMAT = 40029
    TOOL_TIME_UNSUPPORTED_OUTPUT = 40030
    TOOL_STUB_FILE_WRITE_FAILED = 40031    # 寫入錯誤格式檔案失敗
    TOOL_STUB_INVALID_DATA = 40032         # 假資料產生函式收到非法輸入
    TOOL_STUB_UNKNOWN_ERROR = 40033        # 假資料產生未知錯誤
    # ------------------------
    # ❌ 測資任務錯誤碼（410xx）
    # ------------------------
...
ERROR_MESSAGES = {
    ...
    ResultCode.ASSERT_STATUS_CODE_MISMATCH: "狀態碼不符",
    ResultCode.ASSERT_KEYS_MISSING: "缺少必要欄位",
    ResultCode.ASSERT_JSON_MISMATCH: "JSON 結構不一致",
    ResultCode.ASSERT_SUBSTRING_NOT_FOUND: "子字串未包含在主字串中",
    ResultCode.TOOL_TIME_INVALID_TIMEZONE: "時間模組：無效時區",
    ResultCode.TOOL_TIME_INVALID_FORMAT: "時間模組：無效格式",
    ResultCode.TOOL_TIME_UNSUPPORTED_OUTPUT: "時間模組：不支援的輸出格式",
    ResultCode.TOOL_STUB_FILE_WRITE_FAILED: "假資料模組：寫入檔案失敗",
    ResultCode.TOOL_STUB_INVALID_DATA: "假資料模組：非法輸入",
    ResultCode.TOOL_STUB_UNKNOWN_ERROR: "假資料模組：未知錯誤",
...
TOOL_ERROR_CODES = {
    ...
    ResultCode.ASSERT_STATUS_CODE_MISMATCH,
    ResultCode.ASSERT_KEYS_MISSING,
    ResultCode.ASSERT_JSON_MISMATCH,
    ResultCode.ASSERT_SUBSTRING_NOT_FOUND,
    ResultCode.TOOL_TIME_INVALID_TIMEZONE,
    ResultCode.TOOL_TIME_INVALID_FORMAT,
    ResultCode.TOOL_TIME_UNSUPPORTED_OUTPUT,
    ResultCode.TOOL_STUB_FILE_WRITE_FAILED,
    ResultCode.TOOL_STUB_INVALID_DATA,
    ResultCode.TOOL_STUB_UNKNOWN_ERROR,
}
